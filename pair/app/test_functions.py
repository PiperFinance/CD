...
async def _tt_():
    ...
    from utils.transaction.save_transactions import save_users_chain_token_trxs, save_users_all_token_trxs
    from utils.transaction.get_transactions import get_users_chain_token_trxs, get_users_all_token_trxs
    from utils.nft.save_nfts import save_users_chain_nfts, save_users_all_nfts
    from utils.nft.get_nfts import get_users_chain_nfts, get_users_all_nfts
    ...
    # save_users_all_token_trxs("0x416299AAde6443e6F6e8ab67126e65a7F606eeF5")
    ...
    # save_users_chain_nfts(1, "0x76E44E267fD6E0189D71d38A257404C59A1Eb677")
    # save_users_all_nfts("0x76E44E267fD6E0189D71d38A257404C59A1Eb677")
