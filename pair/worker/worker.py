...
from configs import redis_config, celery_config
from utils.transaction.signature import cache_all_signatures
from utils.pair.token_price import cache_coins_id
...
celery_instance = celery_config.config(
    REDIS_URL,
    CELERY_BROKER_URL,
    CELERY_RESULT_URL,
)
...
def startup_task(sender=None, conf=None, **kwargs):
    async_run(redis_config.initialize(REDIS_URL))
